...
const servicesData = [
  {
    ...
    description: 'I Build End-To-End, Production-Style Web Applications By Combining Java And Spring Boot On The Backend With React On The Frontend. From Database Design And Secure APIs To Responsive Interfaces, I Deliver Complete, Deployable Systems.',
    capabilities: [
      'Develop Responsive Web Applications With React.js',
      'Build Secure RESTful APIs Using Spring Boot',
      'Design And Optimize MySQL Databases And Schemas',
  ...
  },
  {
    ...
    description: 'I Develop Secure And Scalable Backend Systems With Well-Structured REST APIs, Efficient Databases, And Authentication Mechanisms To Power Modern Web Applications.',
    capabilities: [
      'Java',
      'Spring Boot',
      'REST APIs',
  ...
  },
  {
    ...
    description: 'I Integrate Third-Party Services And AI-Powered Features Into Applications To Automate Workflows And Improve The Overall User Experience.',
    capabilities: [
      'AI-Powered Chatbots',
      'Twilio API',
  ...
  },
  {
    ...
    description: 'I Design And Optimize Relational Databases That Keep Applications Fast, Consistent, And Reliable As They Scale.',
    capabilities: [
      'MySQL Schema Design',
      'Query Optimization',
      'Hibernate / JPA',
  ...
  },
  {
    id: '06',
    title: 'DevOps & Tools',
    description: 'I Use Modern Tools For Version Control, Testing, And Collaboration To Ensure Reliable And Efficient Software Delivery.',
    capabilities: [
      'Git & GitHub',
      'Postman',
      'MySQL Workbench',
