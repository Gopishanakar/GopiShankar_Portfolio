                ...
                <div className="w-full lg:w-5/12 flex flex-col justify-start">
                    ...
                    <div className="flex flex-col gap-10">
                        ...
                        <div className="hidden md:block">
                            ...
                            <p className="text-xl tracking-wide">gopishan1302@gmail.com</p>
                        </div>
                        ...
                        <div className="mt-4 flex flex-col items-center md:items-start">
                            ...
                            <div className="flex items-center justify-center md:justify-start gap-3">
                                <a href="https://github.com/Gopishanakar" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                ...
                                <a href="mailto:gopishan1302@gmail.com" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
