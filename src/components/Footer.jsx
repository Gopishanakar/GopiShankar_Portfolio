    ...
    <footer className="relative bg-black text-white py-12 px-6 md:px-16 h-screen flex flex-col justify-between overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full justify-between">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-8 gap-10">
          <div className="flex flex-col gap-6 w-full md:w-auto">
            <div>
              ...
              <a href="mailto:gopishan1302@gmail.com" className="text-xl md:text-5xl font-medium hover:text-gray-300 transition-colors break-words">
                gopishan1302@gmail.com
              </a>
            </div>
          ...
          <div className="flex flex-col items-start md:items-end text-left md:text-right w-full md:w-auto mt-4 md:mt-0">
            ...
            <p className="text-gray-400 text-sm mb-6 max-w-xs">
              Open To Entry-Level Full-Stack Opportunities And Collaborations.
            </p>
        ...
        <div className="flex flex-wrap justify-between items-center py-6 border-t border-white/10 mb-4 text-sm md:text-lg font-medium">
          <a href="https://github.com/Gopishanakar" target="_blank" rel="noopener noreferrer" className="hover:text-gray-300 transition-colors">GitHub</a>
          <a href="mailto:gopishan1302@gmail.com" className="hover:text-gray-300 transition-colors">Email</a>
          <a href="tel:+916380000345" className="hover:text-gray-300 transition-colors">Phone</a>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 mt-auto pt-6">
          <p>© {new Date().getFullYear()} Gopishankar K. All Rights Reserved.</p>
